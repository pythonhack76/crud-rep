...
<body>
    <h1 class="my-5">Salve, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Benevenuto nella tua area riservata.</h1>
   ...
   <div class="container">
    ...
    <div class="footer-img"><img src="./imgs/manager.jpg"></div>
</body>
</html>